...
public class IndexHandler : IRequestHandler
{
    ...
    public void Handle(HttpListenerContext ctx)
    {
        ...
        md.AppendLine("- `GET /uassets?search=term` - Fuzzy search for UAssets by name (space-separated tokens, all must match). Optional: `&class=WidgetBlueprint`, `&pathPrefix=/Game`, `&limit=50`. Requires live UE editor.");
