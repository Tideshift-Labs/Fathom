    ...
    public class FathomMcpServer
    {
        ...
        private static readonly ToolDef[] Tools =
        {
            ...
            new ToolDef("get_blueprint_audit",
                "[UE5] Get cached audit data for Blueprints, DataTables, DataAssets, Materials, Control Rigs, BehaviorTrees, StateTrees, and PCG Graphs. Returns 409 if stale, 503 if not ready.",
                "/blueprint-audit"),

            new ToolDef("refresh_blueprint_audit",
                "[UE5] Trigger background refresh of all asset audit data (Blueprints, DataTables, DataAssets, Materials, Control Rigs, BehaviorTrees, StateTrees, PCG Graphs).",
