...
Requires the [CoRider-UnrealEngine](https://github.com/[your-username]/CoRider-UnrealEngine) plugin to be installed in the UE project.
...
- [x] ~~**UE companion plugin for Blueprint audit.**~~ Implemented as [CoRider-UnrealEngine](https://github.com/[your-username]/CoRider-UnrealEngine). The Rider plugin reads JSONs via `/blueprint-audit` endpoint and triggers commandlet runs when data is stale.
